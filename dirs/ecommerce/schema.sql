...
CREATE TABLE `users` (
    ...
    `email` varchar(255) COLLATE utf8mb4_0900_as_ci NOT NULL COMMENT 'Email of the user, now stored case-insensitively',
    ...
    CHECK (`email` REGEXP '^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\x{2,}$'),
