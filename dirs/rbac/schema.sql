...
-- CHANGE: disallow truncation of audit logs by read/write application role (TRUNCATE is separate from DELETE)
REVOKE TRUNCATE ON TABLE "public"."audit_logs" FROM readwrite_role;
