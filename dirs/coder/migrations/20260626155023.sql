...
ALTER TABLE "audit_logs" DROP COLUMN "time", ADD COLUMN "created_at" timestamptz NOT NULL;
-- Create index "idx_audit_logs_org_time_desc" to table: "audit_logs"
CREATE INDEX "idx_audit_logs_org_time_desc" ON "audit_logs" ("organization_id", "created_at" DESC);
-- Create index "idx_audit_logs_time_desc" to table: "audit_logs"
CREATE INDEX "idx_audit_logs_time_desc" ON "audit_logs" ("created_at" DESC);
-- Create index "idx_audit_logs_user_time_desc" to table: "audit_logs"
CREATE INDEX "idx_audit_logs_user_time_desc" ON "audit_logs" ("user_id", "created_at" DESC);
