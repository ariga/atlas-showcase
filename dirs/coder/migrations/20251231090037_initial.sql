...
CREATE TYPE "provisioner_job_type" AS ENUM ('template_version_import', 'workspace_build', 'template_version_dry_run');
...
CREATE TYPE "audit_action" AS ENUM ('create', 'write', 'delete', 'start', 'stop', 'login', 'logout', 'register');
-- Create enum type "parameter_scope"
CREATE TYPE "parameter_scope" AS ENUM ('template', 'import_job', 'workspace');
-- Create enum type "build_reason"
CREATE TYPE "build_reason" AS ENUM ('initiator', 'autostart', 'autostop');
-- Create enum type "login_type"
CREATE TYPE "login_type" AS ENUM ('password', 'github', 'oidc', 'token');
-- Create enum type "api_key_scope"
CREATE TYPE "api_key_scope" AS ENUM ('all', 'application_connect');
...
CREATE TYPE "app_sharing_level" AS ENUM ('owner', 'authenticated', 'public');
-- Create enum type "workspace_transition"
CREATE TYPE "workspace_transition" AS ENUM ('start', 'stop', 'delete');
...
CREATE UNIQUE INDEX "idx_users_username" ON "users" ("username") WHERE (deleted = false);
-- Create index "users_email_lower_idx" to table: "users"
CREATE UNIQUE INDEX "users_email_lower_idx" ON "users" ((lower(email))) WHERE (deleted = false);
-- Create index "users_username_lower_idx" to table: "users"
CREATE UNIQUE INDEX "users_username_lower_idx" ON "users" ((lower(username))) WHERE (deleted = false);
-- Create enum type "resource_type"
CREATE TYPE "resource_type" AS ENUM ('organization', 'template', 'template_version', 'user', 'workspace', 'git_ssh_key', 'api_key', 'group', 'workspace_build', 'license', 'workspace_proxy');
-- Create "insert_apikey_fail_if_user_deleted" function
CREATE FUNCTION "insert_apikey_fail_if_user_deleted" () RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
BEGIN
...
CREATE TABLE "api_keys" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "api_keys_user_id_uuid_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_api_key_name" to table: "api_keys"
CREATE UNIQUE INDEX "idx_api_key_name" ON "api_keys" ("user_id", "token_name") WHERE (login_type = 'token'::login_type);
...
CREATE INDEX "idx_audit_log_organization_id" ON "audit_logs" ("organization_id");
...
CREATE INDEX "idx_audit_logs_time_desc" ON "audit_logs" ("time" DESC);
-- Create "files" table
CREATE TABLE "files" (
...
CREATE TYPE "workspace_agent_lifecycle_state" AS ENUM ('created', 'starting', 'start_timeout', 'start_error', 'ready', 'shutting_down', 'shutdown_timeout', 'shutdown_error', 'off');
...
CREATE FUNCTION "delete_deleted_user_api_keys" () RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
BEGIN
	IF (NEW.deleted) THEN
...
CREATE UNIQUE INDEX "workspace_proxies_lower_name_idx" ON "workspace_proxies" ((lower(name))) WHERE (deleted = false);
...
CREATE INDEX "idx_agent_stats_created_at" ON "workspace_agent_stats" ("created_at");
-- Create index "idx_agent_stats_user_id" to table: "workspace_agent_stats"
CREATE INDEX "idx_agent_stats_user_id" ON "workspace_agent_stats" ("user_id");
...
CREATE TABLE "gitsshkeys" (
  ...
  PRIMARY KEY ("user_id"),
  CONSTRAINT "gitsshkeys_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE NO ACTION
);
...
CREATE UNIQUE INDEX "idx_organization_name" ON "organizations" ("name");
-- Create index "idx_organization_name_lower" to table: "organizations"
CREATE UNIQUE INDEX "idx_organization_name_lower" ON "organizations" ((lower(name)));
-- Create "groups" table
CREATE TABLE "groups" (
  "id" uuid NOT NULL,
  "name" text NOT NULL,
  ...
  CONSTRAINT "groups_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "organization_members" (
  ...
  CONSTRAINT "organization_members_organization_id_uuid_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "organization_members_user_id_uuid_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_organization_member_organization_id_uuid" to table: "organization_members"
CREATE INDEX "idx_organization_member_organization_id_uuid" ON "organization_members" ("organization_id");
-- Create index "idx_organization_member_user_id_uuid" to table: "organization_members"
CREATE INDEX "idx_organization_member_user_id_uuid" ON "organization_members" ("user_id");
...
CREATE TABLE "provisioner_jobs" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "provisioner_jobs_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "provisioner_jobs_started_at_idx" to table: "provisioner_jobs"
CREATE INDEX "provisioner_jobs_started_at_idx" ON "provisioner_jobs" ("started_at") WHERE (started_at IS NULL);
...
CREATE TABLE "parameter_schemas" (
  ...
  CONSTRAINT "parameter_schemas_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "provisioner_jobs" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "provisioner_job_logs" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "provisioner_job_logs_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "provisioner_jobs" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "provisioner_job_logs_id_job_id_idx" to table: "provisioner_job_logs"
CREATE INDEX "provisioner_job_logs_id_job_id_idx" ON "provisioner_job_logs" ("job_id", "id");
...
CREATE TABLE "templates" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "templates_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "templates_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "templates_organization_id_name_idx" to table: "templates"
CREATE UNIQUE INDEX "templates_organization_id_name_idx" ON "templates" ("organization_id", (lower((name)::text))) WHERE (deleted = false);
...
CREATE TABLE "template_versions" (
  ...
  CONSTRAINT "template_versions_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "template_versions_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "template_versions_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "templates" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "template_version_parameters" (
  ...
  CONSTRAINT "template_version_parameters_template_version_id_fkey" FOREIGN KEY ("template_version_id") REFERENCES "template_versions" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE TABLE "template_version_variables" (
  ...
  CONSTRAINT "template_version_variables_template_version_id_fkey" FOREIGN KEY ("template_version_id") REFERENCES "template_versions" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "user_links" (
  ...
  CONSTRAINT "user_links_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "workspace_resources" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "workspace_resources_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "provisioner_jobs" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "workspace_resources_job_id_idx" to table: "workspace_resources"
CREATE INDEX "workspace_resources_job_id_idx" ON "workspace_resources" ("job_id");
...
CREATE TABLE "workspace_agents" (
  ...
  "lifecycle_state" "workspace_agent_lifecycle_state" NOT NULL DEFAULT 'created',
  ...
  "subsystem" "workspace_agent_subsystem" NOT NULL DEFAULT 'none',
  PRIMARY KEY ("id"),
  CONSTRAINT "workspace_agents_resource_id_fkey" FOREIGN KEY ("resource_id") REFERENCES "workspace_resources" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
...
CREATE INDEX "workspace_agents_auth_token_idx" ON "workspace_agents" ("auth_token");
-- Create index "workspace_agents_resource_id_idx" to table: "workspace_agents"
CREATE INDEX "workspace_agents_resource_id_idx" ON "workspace_agents" ("resource_id");
...
CREATE UNLOGGED TABLE "workspace_agent_metadata" (
  ...
  CONSTRAINT "workspace_agent_metadata_workspace_agent_id_fkey" FOREIGN KEY ("workspace_agent_id") REFERENCES "workspace_agents" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "workspace_agent_startup_logs" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "workspace_agent_startup_logs_agent_id_fkey" FOREIGN KEY ("agent_id") REFERENCES "workspace_agents" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "workspace_agent_startup_logs_id_agent_id_idx" to table: "workspace_agent_startup_logs"
CREATE INDEX "workspace_agent_startup_logs_id_agent_id_idx" ON "workspace_agent_startup_logs" ("agent_id", "id");
...
CREATE TABLE "workspace_apps" (
  ...
  "health" "workspace_app_health" NOT NULL DEFAULT 'disabled',
  "subdomain" boolean NOT NULL DEFAULT false,
  "sharing_level" "app_sharing_level" NOT NULL DEFAULT 'owner',
  "slug" text NOT NULL,
  "external" boolean NOT NULL DEFAULT false,
  PRIMARY KEY ("id"),
  CONSTRAINT "workspace_apps_agent_id_slug_idx" UNIQUE ("agent_id", "slug"),
  CONSTRAINT "workspace_apps_agent_id_fkey" FOREIGN KEY ("agent_id") REFERENCES "workspace_agents" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "workspaces" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "workspaces_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "organizations" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "workspaces_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT,
  CONSTRAINT "workspaces_template_id_fkey" FOREIGN KEY ("template_id") REFERENCES "templates" ("id") ON UPDATE NO ACTION ON DELETE RESTRICT
);
-- Create index "workspaces_owner_id_lower_idx" to table: "workspaces"
CREATE UNIQUE INDEX "workspaces_owner_id_lower_idx" ON "workspaces" ("owner_id", (lower((name)::text))) WHERE (deleted = false);
...
CREATE TABLE "workspace_builds" (
  ...
  "reason" "build_reason" NOT NULL DEFAULT 'initiator',
  "daily_cost" integer NOT NULL DEFAULT 0,
  ...
  CONSTRAINT "workspace_builds_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "provisioner_jobs" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "workspace_builds_template_version_id_fkey" FOREIGN KEY ("template_version_id") REFERENCES "template_versions" ("id") ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT "workspace_builds_workspace_id_fkey" FOREIGN KEY ("workspace_id") REFERENCES "workspaces" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "workspace_build_parameters" (
  ...
  CONSTRAINT "workspace_build_parameters_workspace_build_id_fkey" FOREIGN KEY ("workspace_build_id") REFERENCES "workspace_builds" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE "workspace_resource_metadata" (
  ...
  CONSTRAINT "workspace_resource_metadata_workspace_resource_id_fkey" FOREIGN KEY ("workspace_resource_id") REFERENCES "workspace_resources" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
